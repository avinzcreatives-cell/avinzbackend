...
export const getAdminNotificationTemplate = ({ type, data }) => {
  ...
  if (type === 'contact') {
    ...
    badgeColor = '#7c3aed';
    detailsHtml = `
      <tr><td style="padding: 8px 0; color: #64748b; font-weight: 600; width: 140px;">Student Name:</td><td style="color: #0f172a; font-weight: 600;">${data.name}</td></tr>
      <tr><td style="padding: 8px 0; color: #64748b; font-weight: 600;">Email Address:</td><td style="color: #2563eb;"><a href="mailto:${data.email}">${data.email}</a></td></tr>
      <tr><td style="padding: 8px 0; color: #64748b; font-weight: 600;">Phone Number:</td><td style="color: #0f172a;">${data.phone}</td></tr>
      <tr><td style="padding: 8px 0; color: #64748b; font-weight: 600;">Course Selected:</td><td style="color: #7c3aed; font-weight: 700; font-size: 15px;">${data.course}</td></tr>
      <tr><td style="padding: 8px 0; color: #64748b; font-weight: 600;">Learning Mode:</td><td style="color: #0f172a;">${data.mode || 'Online / Classroom'}</td></tr>
      <tr><td style="padding: 8px 0; color: #64748b; font-weight: 600;">Experience Level:</td><td style="color: #0f172a;">${data.experience || 'Beginner'}</td></tr>
      ${data.message ? `
      <tr><td style="padding: 12px 0 4px; color: #64748b; font-weight: 600;" colspan="2">Student Note:</td></tr>
      <tr><td colspan="2" style="background: #f8fafc; border-left: 4px solid #7c3aed; padding: 12px 16px; border-radius: 4px; color: #334155; line-height: 1.6;">${data.message.replace(/\n/g, '<br/>')}</td></tr>
      ` : ''}
    `;
  }
    ...
    <body>
      <div class="container">
        <div class="header">
          ...
          <p>Design Agency & Technology Training Institute</p>
        </div>
        <div class="body">
...
export const getUserConfirmationTemplate = ({ name, type, item }) => {
  ...
  if (type === 'enroll') {
    subjectGreeting = `Enrollment Inquiry Received: ${item}`;
    description = `Thank you for choosing Avinz Creatives for your training in <strong>${item}</strong>. Our student counselor will reach out to you shortly with course schedules, fee details, and next steps!`;
  } else if (type === 'quote') {
  ...
  return `
    ...
    <body>
      <div class="container">
        <div class="header">
          <h1>AVINZ CREATIVES</h1>
          <p style="margin: 6px 0 0; color: #93c5fd; font-size: 14px;">Design • Develop • Train • Empower</p>
        </div>
        <div class="body">
          ...
          <div class="cta-box">
            ...
            <div style="margin-top: 12px;">
              <a href="tel:+919876543210" class="contact-pill">📞 +91 98765 43210</a>
              <a href="mailto:hello@avinzcreatives.in" class="contact-pill">✉️ hello@avinzcreatives.in</a>
            </div>
          </div>
